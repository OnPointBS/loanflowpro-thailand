            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700">
                  You are previewing the client portal as it would appear to {invitation.email}
                </p>
              </div>
            </div>
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700 mt-1">
                          This is a preview. The client needs to accept their invitation to access their actual portal.
                        </p>
                      </div>
                    </div>
                  </CardContent>
